...
class RandomBeansTestParameterExtensionTest {

    @Test
    void randomBeanGenerateStringParameter(@RandomBean String string) {
    ...
    @Test
    void randomBeanGenerateBeanParameter(@RandomBean TestData data) {
    ...
    @Test
    void randomBeanGenerateGenericListBeanParameter(@RandomBean List<TestData2> list) {
    ...
    @Test
    void randomBeanGenerateGenericSetBeanParameter(@RandomBean Set<TestData2> list) {
        System.out.println(list);
        assertThat(list).isNotEmpty()
                .allMatch(testData2 -> !isNullOrEmpty(testData2.string));
    }
    ...
    @Test
    void randomBeanGenerateGenericQueueBeanParameter(@RandomBean Queue<TestData2> list) {
        System.out.println(list);
        assertThat(list).isNotEmpty()
                .allMatch(testData2 -> !isNullOrEmpty(testData2.string));
    }
    ...
    @Test
    void randomBeanGenerateGenericMapBeanParameter(@RandomBean Map<TestKey, TestData2> map) {
